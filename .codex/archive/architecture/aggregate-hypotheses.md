...
| ------------------------ | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Aquarium — accepted root | Establish the management context for related care information and its system boundary. | The first private establishment is accepted; component setup and detailed topology remain future slices. |
...
| Equipment association    | Describe an equipment item's relationship to an Aquarium or one of its components.     | Ownership, sharing, installation and safety constraints.                                                 |
