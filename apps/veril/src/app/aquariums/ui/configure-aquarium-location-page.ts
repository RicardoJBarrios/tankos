...
import { OpenMeteoLocationSearch } from '../infrastructure/open-meteo-location-search';
import {
...
export class ConfigureAquariumLocationPage implements OnInit {
  ...
  readonly candidates = signal<
    readonly import('../application/aquarium-ports').LocationCandidate[]
  >([]);
  readonly selected = signal<
    import('../application/aquarium-ports').LocationCandidate | null
  >(null);
  ...
  select(
    candidate: import('../application/aquarium-ports').LocationCandidate,
  ): void {
