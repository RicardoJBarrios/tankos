...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/units',
  plugins: [
    angular(),
  ...
  resolve: {
    ...
    alias: {
      ...
      '@tankos/decimal': resolve(__dirname, '../decimal/src/index.ts'),
      '@tankos/data-access': resolve(__dirname, '../data-access/src/index.ts'),
    },
  },
  test: {
    name: 'units',
